package cn.worldwalker.game.jinhua.common.cards;
...
public class CardRule {
	 ...
	 * @param playerCards
	 */
	public static PlayerInfo comparePlayerCards(List<PlayerInfo> playerList){
		PlayerInfo maxPlayer = playerList.get(0);
		int playerNum = playerList.size();
		for(int k = 1; k < playerNum; k++){
			PlayerInfo curPlayer = playerList.get(k);
	 ...
	 */
	public static int compareTwoPlayerCards(PlayerInfo player1, PlayerInfo player2){
		int result = 0;
	 ...
	 * @return
	 */
	public static int singleCompare(PlayerInfo player1, PlayerInfo player2){
		int result = 0;
	 ...
	 * @return
	 */
	public static int jinhuaCompare(PlayerInfo player1, PlayerInfo player2){
		int result = 0;
		/**如果三张牌的牌值相等，则志需要比较最大牌的花色*/
		if (compareTwoCardWithCardValue(player1.getCardList().get(0), player2.getCardList().get(0)) == 0 
			&& compareTwoCardWithCardValue(player1.getCardList().get(1), player2.getCardList().get(1)) == 0
	 ...
	 * @return
	 */
	public static int pairCompare(PlayerInfo player1, PlayerInfo player2){
		int result = 0;
		/**如果三张牌的牌值相等，则志需要比较最大牌的花色*/
		if (compareTwoCardWithCardValue(player1.getCardList().get(0), player2.getCardList().get(0)) == 0 
			&& compareTwoCardWithCardValue(player1.getCardList().get(1), player2.getCardList().get(1)) == 0
